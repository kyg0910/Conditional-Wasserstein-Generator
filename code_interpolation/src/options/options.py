...
class BaseOptions(object):
    def __init__(self):
        ...
        # multi-gpu
        multi_gpu_arg_group = self.parser.add_argument_group('Multi GPU')
        multi_gpu_arg_group.add_argument('--gpu_id', nargs='+', type=int, help='id of gpus for parallel computing. Multi-GPU computation is available for only Wasserstein video interpolator.')
...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        opt_arg_group.add_argument('--seed', type=int, default=0, help='random seed number')
        ...
        opt_arg_group.add_argument('--weight_decay', type=float, default=0.0, help='Weight decay term of adam')
        ...
        loss_arg_group.add_argument('--gamma', type=float, default=0.01, help='Lipschitz loss weight')
        loss_arg_group.add_argument('--L', type=float, default=1.0, help='Lipschitz constant')
        ...
        training_data_load_arg_group.add_argument('--not_validate_alt', dest='not_validate_alt', action='store_true', help='Whether calulate performances on validation with alternative lengths of frames')
