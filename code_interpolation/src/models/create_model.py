...
from .wvi_tai.wvi_tai import WVITAIFillInModel
from .wvi_slomo.wvi_slomo import WVISloMoFillInModel

def create_model(model_key, gpu_id):
    ...
    if model_key == 'WVI_TAI_gray':
        return WVITAIFillInModel(64, 1, 3, 51, num_block=5, gpu_id=gpu_id)
    if model_key == 'WVI_TAI_color':
        return WVITAIFillInModel(64, 3, 3, 51, num_block=4, gpu_id=gpu_id)
    if model_key == 'WVI_SloMoFillInModel_color':
        return WVISloMoFillInModel(32, 3)
    if model_key == 'WVI_SloMoFillInModel_gray':
        return WVISloMoFillInModel(32, 1)
